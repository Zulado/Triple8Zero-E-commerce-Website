...
<body id="login-register-body" class="body">
    <nav id="register-login-nav">
        <div onclick="window.location='../index.php'" class="register-items">
            <image id="header-logo" src="../resource\images\triple8zerologo.png">

            </image>
            <h1 style="margin-top: 25px;" id="header-title"><span id="eco-green">Triple 8</span> Zero <span id="login-register-title">| Log In</span></h1>
        </div>
        ...
        <div class="login-register-items  flex flex-center">
            <div class="login-container">
                ...
                <div class="flex flex-center">
                    <span id="new-to-eco">New to Triple 8 Zero?</span><span id="sign-up"><a id="sign-up" href="../user/register.php">&nbsp;Sign Up</a ></span>
                </div>
    ...
    <section class="footer">
        ...
        <div id="footer-item-2">
            ...
            <br><br>
            <span class="footer-item-list">Welcome to Triple 8 Zero! We provide delivery services for all around Malaysia. With over 10 years of experience, we asure you with the best product quality and services.</span>
        </div>
        ...
        <div id="footer-item-3">
            ...
            <br>
            <span class="footer-item-list">Email: admin@Triple 8 Zero.com</span>
        </div>
    </section>
