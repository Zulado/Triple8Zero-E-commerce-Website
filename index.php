...
<body class="body">
    <header>
        <div class="container-wrapper">
            <div onclick="window.location='index.php'" id="header-logo-contianer">
                ...
                <h2 id="header-title">Triple 8 Zero</h2>
            </div>
    ...
    <section class="footer">
        <div id="footer-item-1">
            ...
            <br>
            <span class="footer-item-list"><a href="https://youtu.be/N_ndMlT0PGY">User Manual</a></span>
            <br>
        </div>
        ...
        <div id="footer-item-2">
            ...
            <br><br>
            <span class="footer-item-list">Welcome to Triple 8 Zero! We provide delivery services for all around Malaysia. We asure you with the best product quality and services.</span>
        </div>
